# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-gmsh
#
...
project = u'aiida-gmsh'
copyright_first_year = '2021'
copyright_owners = 'Philipp Diercks'
...
release = aiida_gmsh.__version__
...
html_use_opensearch = 'http://aiida-gmsh.readthedocs.io'
...
htmlhelp_basename = 'aiida-gmsh-doc'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida_gmsh')
